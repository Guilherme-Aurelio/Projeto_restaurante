...
from PySide6.QtWidgets import (QApplication, QComboBox, QFrame, QGridLayout,
    ...
    QStatusBar, QTabWidget, QWidget, QMessageBox, QScrollArea)
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scroll = QScrollArea(self.gridLayoutWidget_5)
        ...
        self.scroll.setFixedSize(300, 130)
        
        self.label_nota.setWordWrap(True)
        self.gridLayout_5.addWidget(self.scroll, 0, 0, 1, 1)
