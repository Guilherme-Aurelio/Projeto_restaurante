...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.setGeometry(QRect(10, 10, 680, 500))
        self.tab = QWidget()
        ...
        self.label_desc_card.setFont(font5)
        ...
        self.label_valor_card.setFont(font5)
        ...
        self.ok_cad.clicked.connect(self.exibirComboBox)
        self.ok_exc.clicked.connect(self.excluirProduto)
        ...
        self.ok_cad.clicked.connect(self.add_to_combo)
        self.desc_dict = {} 
        self.valor_dict = {}        
        self.quant_dict = {}
        self.comboBox_card.currentTextChanged.connect(self.update_label_descricao)
        self.ok_cad.clicked.connect(self.showMessage)
        self.ok_exc.clicked.connect(self.showMessage1)
        self.ok_edi.clicked.connect(self.showMessage2)
        self.ok_card.clicked.connect(self.notaFiscal)
        self.ok_edi.clicked.connect(self.editar)
        self.cancelar_cad.clicked.connect(self.cancelar_bot_cad)
        self.cancelar_edi.clicked.connect(self.cancelar_bot_edi)
        self.cancelar_card.clicked.connect(self.cancelar_pedido)
        self.cancelar_exc.clicked.connect(self.cancelar_bot_exc)
    ...
    def update_label_descricao(self):
    ...
    def editar(self):
        ...
        '''
    def cancelar_bot_cad(self):
        self.desc_cad.clear()
        self.nome_cad.clear()
        self.valor_cad.clear()

    def cancelar_bot_edi(self):
        self.desc_edi.clear()
        self.nome_edi.clear()
        self.valor_edi.clear()
        self.comboBox_edi.setCurrentIndex(0)
